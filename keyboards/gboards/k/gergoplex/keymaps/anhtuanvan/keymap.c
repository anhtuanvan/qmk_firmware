 ...
 * |     |     |    GRT   P_UP   |       |     |    LES    |    BSLASH |
 * |-----+-----+-----+-----+-----|       |-----+-----+-----+-----+-----|
 * |     |  BSPC   S_TAB  HOME   |       |    END   TAB   DEL   |     |
 * |-----+-----+-----+-----+-----|       |-----+-----+-----+-----+-----|
 * |     |   QUOTE  DASH  P_DOWN |       |     |   UNDR  COLON   |     |
 * '-----------------------------'       '-----------------------------'
 *  .-------------------------.             .-------------------------.
 *  |        |       |        |             |        |        |       |
 *  '-------------------------'             '-------------------------'
 ...
 * `------+-----+-----+-----+-----'      `--------------------------------'
 *  .-------------------------.           .-------------------------.
 *  |ESC/ALT|ENT/META|SPC(SYM)|           |SPC(NUM)|ENT/META|ESC/ALT|
 *  '-------------------------'           '-------------------------'
 */
[BASE] = LAYOUT_gergoplex(
    ...
    MT(MOD_RSFT, KC_Z),KC_X, KC_C, KC_V, KC_B,  	KC_N, KC_M, KC_COMM, KC_DOT, MT(MOD_RSFT, KC_SLSH),
 		...
 		MT(MOD_LALT, KC_ESC), MT(MOD_LGUI, KC_ENT), LT(SYMB, KC_SPC),									// Left
		LT(NUMB, KC_SPC), MT(MOD_RGUI, KC_ENT), MT(MOD_RALT, KC_ESC)																// Right
    ),
